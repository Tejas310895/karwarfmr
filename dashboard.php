...
$get_bonus = "select sum(bonus_amt) as bonus_total from fmr_bonus where fmr_id='$fmr_id'";
$run_bonus = mysqli_query($con,$get_bonus);
$row_bonus = mysqli_fetch_array($run_bonus);
$bonus_total = $row_bonus['bonus_total'];

$get_credits = "select sum(settlement_amt) as credit_total from fmr_settlements where fmr_id='$fmr_id'";
$run_credits = mysqli_query($con,$get_credits);
$row_credits = mysqli_fetch_array($run_credits);

$credit_total = $row_credits['credit_total'];

$get_debits = "select sum(fmr_debit_amt) as debit_total from fmr_debits where fmr_id='$fmr_id'";
$run_debits = mysqli_query($con,$get_debits);
$row_debits = mysqli_fetch_array($run_debits);

$debit_total = $row_debits['debit_total'];

$current_balance = (($earnings*0.01)+$bonus_total)-($credit_total+$debit_total);
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title text-md-center text-xl-left">Current Balance</h2>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo $current_balance; ?>/-</h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo $client_count; ?></h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Bonus</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php echo $bonus_total; ?>/-</h3>
          ...
          <!-- <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Your Growth</p>
